...
if __name__ == "__main__":
    ...
    main()
"""
python3 -m zipvoice.bin.train_zipvoice     --world-size 1     --num-epochs 2     --max-duration 200     --exp-dir exp/zipvoice_finetune_vlsp100     --model-config zip_2500/model.json     --token-file zip_2500/tokens.txt     --dataset custom     --train-manifest  data/manifests/vlsp100_cuts_train.jsonl.gz --dev-manifest data/manifests/vlsp100_cuts_train.jsonl.gz     --checkpoint zip_2500/iter-525000-avg-2.pt     --finetune True     --base-lr 1e-5      --valid-by-epoch False
